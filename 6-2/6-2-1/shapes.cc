...
Rectangle::Rectangle(const size_t x, const size_t y, const char brush, const size_t width, const size_t height) : Shape(x, y, brush), width(width), height(height) {}
...
UpTriangle::UpTriangle(const size_t x, const size_t y, const char brush, const size_t height) : Shape(x, y, brush), height(height) {}
...
DownTriangle::DownTriangle(const size_t x, const size_t y, const char brush, const size_t height) : Shape(x , y, brush), height(height) {}
